...
const VendorLanding = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-b from-white to-[#FFF8EC]">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={m.v} className="text-center">
                  <div className="text-2xl font-extrabold text-[#D4AF37]">{m.k}</div>
                  <div className="mt-1 text-xs font-semibold text-white/75">{m.v}</div>
                </div>
              ))}
            </div>
          </div>
