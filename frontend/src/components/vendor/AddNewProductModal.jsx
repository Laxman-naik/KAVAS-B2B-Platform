      ...
      >
        <div className="flex shrink-0 items-start justify-between gap-4 border-b border-slate-200 bg-white px-6 py-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={close}
              className="ml-1 flex h-9 w-9 items-center justify-center rounded-sm border border-slate-200 text-slate-500 transition-colors hover:bg-slate-50"
              aria-label="Close"
            >
              <X className="h-4 w-4" />
            </button>
                  ...
                  <div className="px-5 py-5">
                    ...
                    <div className="mt-4 rounded-sm border border-slate-200 bg-slate-50 p-4">
                      <div className="mb-3 flex items-center gap-2">
                        ...
                        <p className="text-sm font-bold text-slate-900">
                          Product Trust & Delivery Options
                        </p>
                      </div>
                      ...
                      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                        <CheckBoxField
                          ...
                          onChange={(e) =>
                            update("codAvailable")(e.target.checked)
                          }
                        />
                        ...
                        <CheckBoxField
                          ...
                          onChange={(e) =>
                            update("isOriginal")(e.target.checked)
                          }
                        />

                        <CheckBoxField
                          label="GST Invoice"
                          checked={form.gstInvoiceAvailable}
                          onChange={(e) =>
                            update("gstInvoiceAvailable")(e.target.checked)
                          }
                        />

                        <CheckBoxField
                          label="Secure Payment"
                          checked={form.securePaymentAvailable}
                          onChange={(e) =>
                            update("securePaymentAvailable")(e.target.checked)
                          }
                        />

                        <CheckBoxField
                          label="Return / Exchange"
                          checked={form.returnExchangeAvailable}
                          onChange={(e) =>
                            update("returnExchangeAvailable")(e.target.checked)
                          }
                        />

                        <CheckBoxField
                          label="Fast Delivery"
                          checked={form.fastDeliveryAvailable}
                          onChange={(e) =>
                            update("fastDeliveryAvailable")(e.target.checked)
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div className="mt-4">
                      <Field label="Product Description" required>
                        <Textarea
                          className="min-h-27.5 rounded-md border border-slate-200 bg-white text-sm text-slate-800 placeholder:text-slate-400 transition-all focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30"
              ...
              <div className="space-y-6">
                <div className="rounded-sm border border-slate-200 bg-white">
                  ...
                  <div className="px-5 py-5">
                    ...
                    <div className="mt-3">
                      <label className="flex h-24 w-full cursor-pointer flex-col items-center justify-center rounded-md border-2 border-dashed border-slate-300 bg-slate-50 transition hover:bg-slate-100">
                        <Upload className="h-6 w-6 text-slate-500" />
