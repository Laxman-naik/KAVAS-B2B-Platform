...
//             <input type="email" name="email" value={form.email} onChange={handleChange} placeholder="you@company.com" className="w-full mt-0.5 px-3 py-1.5 sm:py-2 border rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-orange-500" />
//           </div>
//           <div>
//             <label className="text-xs sm:text-sm font-medium">Password</label>
//             <input type="password" name="password" value={form.password} onChange={handleChange} placeholder="Enter password" className="w-full mt-0.5 px-3 py-1.5 sm:py-2 border rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-orange-500" />
//           </div>
