    ...
    >
      ...
      >
        <div className="relative flex items-center">
          ...
          <button
            onClick={scrollLeft}
            className="absolute left-0 z-10 bg-white px-2 h-full shadow"
          >
            ◀
          </button>
          ...
          <button
            onClick={scrollRight}
            className="absolute right-0 z-10 bg-white px-2 h-full shadow"
          >
            ▶
          </button>
        </div>
      ...
      <div className="space-y-3">
        ...
        >
          {activeCategory && (
            <div className="bg-white dark:bg-gray-800 shadow-xl border-t p-2 sm:p-5 w-[700px]">
              <h2 className="text-sm sm:text-lg font-semibold mb-4 text-left">
                {activeCategory.name}
              </h2>

              {/* ✅ Vertical Meesho style */}
