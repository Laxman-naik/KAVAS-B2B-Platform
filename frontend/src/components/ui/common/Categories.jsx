...
const Categories = () => {
  const categories = [
    ...
    },
    {
      name: "Fashion Wear",
      image:
        "https://images.pexels.com/photos/14642654/pexels-photo-14642654.jpeg",
      subcategories: [
        "Men’s Clothing",
        "Women’s Clothing",
        "Kids’ Clothing",
    ...
    },
    {
      name: "Baby Products",
      image:
        "https://media.istockphoto.com/id/864501328/photo/baby-products-symbols-for-newborns.jpg?b=1&s=612x612&w=0&k=20&c=0nl2Ts-j1A6yrflXG9Xry9w-Ob2Tw3RDQodIPUSZB-c=",
      subcategories: [
        "Baby Clothing",
        "Feeding Supplies",
        "Diapers & Wipes",
  ...
  return (
    ...
    >
      ...
      {isScrolled && <div style={{ height: navHeight }} />}
      ...
      <div className="space-y-3">
        ...
        >
          {activeCategory && (
            <div className="bg-white shadow-xl border-t p-2 sm:p-5 pt-10 mt-5 sm:pt-8 w-175">
              <h2 className="text-sm sm:text-lg font-semibold mb-4 text-left text-[#0B1F3A]">
                {activeCategory.name}
              </h2>
