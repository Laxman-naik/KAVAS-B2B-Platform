          ...
          <Card>
            ...
            {/* <div className="mt-4 grid grid-cols-1 gap-4">
              {addresses.map((item) => (
                <button
                  ...
                  className={`rounded-sm border p-4 text-left transition ${selectedAddress === item.id
            ...
            <div className="mt-4 grid grid-cols-1 gap-4">
              {defaultAddress && (
                <div className="mt-4">
                  <button
                    className="w-full rounded-sm border border-[#f3a51c] bg-[#fff8ea] p-4 text-left"
                  >
                    <div className="flex gap-3">
                      <Radio active />
          ...
          <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-2">
            {paymentMethods.map(([id, title, subtitle]) => (
              <button
                ...
                className={`rounded-sm border p-3 text-left transition ${selectedPayment === id
                  ? "border-[#f3a51c] bg-[#fff8ea]"
                  : "border-[#d8dee8] bg-white hover:border-[#f3a51c]"
                  }`}
              >
