...
export default function SubCategoryPage() {
  ...
  }, [normalizedProducts, filters, sortOption, subcategory]);
 
  useEffect(() => {
    setCurrentPage(1);
  }, [filters, sortOption, category, subcategory]);
      ...
      <div className="max-w-350 mx-auto px-4 py-6">
        <div className="mb-5">
          <p className="text-xs text-gray-600" style={{ color: COLORS.muted }}>
            ...
            <span className="mx-2">››</span>
            <span className="text-[#0B1F3A] font-medium capitalize" style={{ color: COLORS.primary }}>
              {subcategorySlug?.replaceAll("-", " ")}
            </span>
          </p>
        </div>
 
        <h1 className="text-3xl font-bold mt-2 text-[#0B1F3A] capitalize" style={{ color: COLORS.primary }}>
