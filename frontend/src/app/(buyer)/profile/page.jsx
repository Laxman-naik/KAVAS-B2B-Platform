...
const Page = () => {
    ...
    const memberSince = authUser?.createdAt || authUser?.created_at || "May 15, 2024";
    ...
    const recentOrders = [
        { id: "#KAVAS1234", date: "15 May 2024", amount: 2450, status: "Delivered" },
        { id: "#KAVAS1233", date: "12 May 2024", amount: 3120, status: "Shipped" },
        { id: "#KAVAS1232", date: "09 May 2024", amount: 1890, status: "Processing" },
        { id: "#KAVAS1231", date: "05 May 2024", amount: 4230, status: "Delivered" },
    ];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-6">
                    ...
                    <div className="p-4 sm:p-6 lg:p-8 space-y-6">
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                            <div>
                                <h1 className="text-xl sm:text-2xl font-bold text-[#0B1F3A]">My Profile</h1>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-[160px_1fr] gap-6 items-center">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <p className="font-semibold text-[#0B1F3A]">{user.firstName} {user.lastName}</p>
                                        </div>
                                        <div>
                                            <p className="text-xs text-gray-500">Mobile Number</p>
                                            <p className="font-semibold text-[#0B1F3A]">{user.phone || "-"}</p>
                                        </div>
                                        <div>
                                            <p className="text-xs text-gray-500">Email Address</p>
                                            <p className="font-semibold text-[#0B1F3A] break-all">{user.email || "-"}</p>
                                        </div>
                                        <div>
                            ...
                            <Card className="rounded-sm border border-[#E5E5E5]">
                                <CardContent className="p-4 flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-bold text-[#0B1F3A]">{stats.totalOrders}</p>
                                        <Link href="/buyerorders" className="text-xs text-[#0B1F3A] hover:underline">View all orders →</Link>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="rounded-sm border border-[#E5E5E5]">
                                <CardContent className="p-4 flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-bold text-[#0B1F3A]">{stats.pendingOrders}</p>
                            ...
                            <Card className="rounded-sm border border-[#E5E5E5]">
                                <CardContent className="p-4 flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-bold text-[#0B1F3A]">{stats.deliveredOrders}</p>
                                        <span className="text-xs text-[#0B1F3A]">View details →</span>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="rounded-sm border border-[#E5E5E5]">
                                <CardContent className="p-4 flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-bold text-[#0B1F3A]">₹{stats.totalSpent.toLocaleString()}</p>
                        ...
                        <Card className="rounded-sm border border-[#E5E5E5]">
                            <CardContent className="p-0">
                                <div className="px-4 py-3 border-b border-[#E5E5E5] flex items-center justify-between">
                                    ...
                                    <Link href="/buyerorders" className="text-xs text-[#D4AF37] hover:underline">View All Orders →</Link>
                                </div>
                                        ...
                                        <tbody>
                                            {recentOrders.map((o) => (
                                                <tr key={o.id} className="border-t">
                                                    <td className="px-4 py-4 font-semibold text-[#0B1F3A]">{o.id}</td>
                                                    <td className="px-4 py-4 text-gray-600">{o.date}</td>
                                                    <td className="px-4 py-4 font-semibold text-[#0B1F3A]">₹{o.amount.toLocaleString()}</td>
                                                    <td className="px-4 py-4">
                                                        <Badge className={statusBadge(o.status)}>{o.status}</Badge>
                                                    </td>
                                                    <td className="px-4 py-4">
                                                        <span className="text-xs text-[#0B1F3A] hover:underline cursor-pointer">View Details</span>
                                                    </td>
                                                </tr>
                                            ))}
                                        </tbody>
                        ...
                        <Card className="rounded-sm border border-[#E5E5E5]">
                            <CardContent className="p-0">
                                <div className="px-4 py-3 border-b border-[#E5E5E5] flex items-center justify-between">
                                    ...
                                    <Link href="/myaddresses" className="text-xs text-[#D4AF37] hover:underline">Manage Addresses →</Link>
                                </div>
                                ...
                                <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                                            ...
                                            <CardContent className="p-4">
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <div className="min-w-0">
                                                        <p className="font-semibold text-[#0B1F3A] text-sm">{a?.label || "Address"}</p>
                                    ...
                                    <Card className="rounded-sm border border-dashed border-[#E5E5E5]">
                                        <CardContent className="p-4 h-full flex items-center justify-center">
                                            <Link href="/myaddresses" className="text-sm font-semibold text-[#0B1F3A] hover:underline">+ Add New Address</Link>
                                        </CardContent>
                                    </Card>
                                </div>
                            </CardContent>
