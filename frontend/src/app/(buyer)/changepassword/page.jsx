...
const Page = () => {
  ...
  const strength = useMemo(() => {
    ...
    if (!newPassword) {
      return { label: "", color: "text-gray-500", bar: "w-0" };
    }
  ...
  const RuleItem = ({ ok, children }) => (
    <div className="flex items-center gap-2 text-xs">
      ...
      />
      <span className={ok ? "text-[#0B1F3A]" : "text-gray-500"}>
        {children}
      </span>
    </div>
  );
  ...
  <CardContent className="p-5 sm:p-6">
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_1px_1.4fr] gap-6 lg:gap-8 items-center">
      <div className="flex items-start gap-4">
        <div className="h-14 w-14 shrink-0 rounded-full bg-[#0B1F3A]/10 flex items-center justify-center">
          <ShieldCheck className="text-[#0B1F3A]" size={27} />
        </div>
      ...
      <div className="hidden lg:block h-28 w-px bg-[#E5E5E5]" />
                ...
                <CardContent className="p-4 sm:p-6">
                  ...
                  <form className="mt-4 space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      />
                      <label
                        htmlFor="logoutOthers"
                        className="text-xs text-gray-600"
                      >
                        Log out from other devices
                        <div className="text-[11px] text-gray-500">
                          We will log you out from other devices for your
                          security.
                        </div>
                      </label>
                    </div>
                    ...
                    <Button
                      type="submit"
                      disabled={loading}
                      className="w-full sm:w-auto bg-[#0B1F3A] text-[#D4AF37] rounded-sm hover:bg-[#0B1F3A]/95 font-semibold disabled:opacity-60"
                    >
                      <RefreshCcw
                        size={16}
                    ...
                    <div className="mt-4 space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 mt-1">
                            Avoid using common words, names or easy to guess
                            information.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 mt-1">
                            Update your password periodically to keep your
                            account secure.
                          </p>
                        </div>
                      </div>
