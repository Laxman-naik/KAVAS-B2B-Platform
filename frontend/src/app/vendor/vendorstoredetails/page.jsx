...
export default function VendorStoreDetailsPage() {
  ...
  const navItems = useMemo(
    () => [
      ...
      { id: "store_pickup", label: "Store & Pickup Details", complete: false, active: true },
    ],
    []
  );
            ...
            <div className="rounded-2xl bg-white border border-[#E5E5E5] shadow-sm p-5">
              ...
              <div className="mt-3">
                <div className="flex items-center justify-between text-[11px]">
                  <div className="text-gray-600 font-semibold">60%</div>
                </div>
                <div className="mt-2 h-2 rounded-full bg-[#E5E5E5] overflow-hidden">
                  <div className="h-full w-[60%] bg-[#0B1F3A]" />
                </div>
              </div>
                  ...
                  {navItems.map((x) => (
                    <div key={x.id} className="flex items-center gap-2 text-[11px]">
                      {x.complete ? (
                        ...
                        <Circle size={14} className="text-[#0B1F3A] fill-[#0B1F3A]" />
                      ) : (
                        <Circle size={14} className="text-gray-300" />
                      )}
                      <div className={x.active ? "text-[#0B1F3A] font-bold" : "text-gray-600 font-semibold"}>
                        {x.label}
                      </div>
                    </div>
                  ))}
            ...
            <div className="rounded-2xl bg-white border border-[#E5E5E5] shadow-sm p-6 sm:p-8">
              ...
              <form onSubmit={onSubmit} className="mt-6 grid gap-6">
                <div>
                  ...
                  <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-2 rounded-xl border border-[#E5E5E5] bg-white p-3">
                        <div className="h-24 rounded-lg bg-[#F3F9FF] border border-[#D9EAFF] flex items-center justify-center overflow-hidden">
                          {storeImageUrl ? (
                            // eslint-disable-next-line @next/next/no-img-element
                            <img src={storeImageUrl} alt="Store" className="h-full w-full object-cover" />
                          ) : (
                            <div className="text-center">
                              <ImagePlus size={20} className="mx-auto text-[#0B1F3A]" />
                              <div className="mt-1 text-[11px] font-semibold text-gray-600">Upload Store Image</div>
                            </div>
                          )}
                        </div>

                        <div className="mt-3 flex items-center justify-between">
                          <div className="text-[10px] text-gray-500">Recommended: 1200×800px, Max: 5MB</div>
                          <div className="flex items-center gap-2">
                            <input
                            ...
                            <button
                              ...
                              className="h-9 rounded-md bg-[#0B1F3A] px-3 text-[11px] font-extrabold text-white hover:opacity-95 inline-flex items-center gap-2"
                            >
                              <Upload size={14} />
                              Upload
                            </button>
                            <button
                              ...
                              className="h-9 rounded-md border border-[#E5E5E5] bg-white px-3 text-[11px] font-extrabold text-[#0B1F3A] hover:bg-[#F3F9FF] inline-flex items-center gap-2"
                            >
                              <X size={14} />
                              Remove
                            </button>
                    ...
                    <div>
                      ...
                      <div className="mt-2 rounded-xl border border-[#E5E5E5] bg-white p-3">
                        <div className="h-24 rounded-lg bg-[#F3F9FF] border border-[#D9EAFF] flex items-center justify-center overflow-hidden">
                          {storeLogoUrl ? (
                            // eslint-disable-next-line @next/next/no-img-element
                            <img src={storeLogoUrl} alt="Logo" className="h-full w-full object-contain bg-white" />
                          ) : (
                            <div className="text-center">
                              <Store size={20} className="mx-auto text-[#0B1F3A]" />
                              <div className="mt-1 text-[11px] font-semibold text-gray-600">Upload Store Logo</div>
                            </div>
                          )}
                        </div>

                        <div className="mt-3 flex items-center justify-between">
                          <div className="text-[10px] text-gray-500">Recommended: 512×512px, Max: 2MB</div>
                          <div className="flex items-center gap-2">
                            <input
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <button
                    type="submit"
                    className="h-11 rounded-md bg-[#0B1F3A] px-6 text-sm font-extrabold text-white hover:opacity-95"
                  >
                    Submit
                  </button>
                </div>
